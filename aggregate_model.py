...
model_endpoints = [
    "http://127.0.0.1:5001/predict",  # CNN
    "http://127.0.0.1:5002/predict",  # DNN
    "http://127.0.0.1:5003/predict",  # LSTM
    "http://127.0.0.1:5004/predict",  # RNN
    "http://127.0.0.1:5005/predict"   # Transformer
]
